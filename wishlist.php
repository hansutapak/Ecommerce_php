  ...
  <body>
    <div class="container">
      ...
      <div class="fixed-top-sec">
        ...
        <section class="categories">
          ...
          <a
            ...
            >Footwear</a
          >
          <a href="product-categories/sportproduct.php" class="jersey-category"
            >Sports</a
          >
      ...
      <div class="wishlist-main">
        <h2>Your Wishlist</h2>
        <p class="wishlist-count">3 items</p>

        <div class="wishlist-items">
          <!-- Wishlist Item 1 -->
          <div class="wishlist-item">
            <div class="item-image">
              <img src="category/socks/men7.jpg" />
            </div>
            <div class="item-details">
              <h3>Running Shoes</h3>
              <p>Best for casual running and wear</p>
          ...
          <div class="wishlist-item">
            <div class="item-image">
              <img src="category/kids/dress3.jpg" />
            </div>
            <div class="item-details">
              <h3>Manchester United Jersey</h3>
              <p>Official 2024 home kit</p>
          ...
          <div class="wishlist-item">
            <div class="item-image">
              <img src="category/sport/boot1.jpg" />
            </div>
            <div class="item-details">
              <h3>Sports Socks Pack</h3>
              <p>3 pairs - moisture wicking</p>
