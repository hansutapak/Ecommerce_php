...
<body>
  <div class="container">
    ...
    <div class="products-main">
      <h2>Kid's Apparel <span class="product-count">(<?php echo $product_count; ?>)</span></h2>
      <p>
        Keep them warm and comfy with a selection from our kids sweatshirt
        range, featuring hundreds of differently sweater styles to cater for
        every kid's needs. Sweaters are an all-season wardrobe staple,
        offering casual comfort and timeless style, and our collection
        features all the best brands so quality is assured. We stock kids
        sweatshirts from Nike, Converse, Calvin Klein, adidas and lots more,
        with lots of different colours and styles to suit their tastes.
        Classic sweater looks like black and grey Nike sweatshirts are
        popular, while more vibrant colours and print designs can also be
        found.
      </p>
      <hr />
      ...
      <div class="products-container">
        ...
        <div class="filter-section">
          ...
          <!-- form -->
          <form method="GET" action="kidproduct.php">
            ...
            <?php if (isset($_GET['category']) || isset($_GET['price']) || isset($_GET['size'])): ?>
              <br>
              <a href="kidproduct.php" style="text-align: center; display: block; margin-top: 10px; color: #3498db;">
                Clear All Filters
              </a>
            <?php endif; ?>
          </form>
        ...
        <div class="filter-mobile-section">
          ...
          <div class="filter-mobile-content">
            ...
            <form method="GET" action="kidproduct.php">
              ...
              <?php if (isset($_GET['category']) || isset($_GET['price']) || isset($_GET['size'])): ?>
                <br>
                <a href="kidroduct.php" style="text-align: center; display: block; margin-top: 10px; color: #3498db;">
                  Clear All Filters
                </a>
              <?php endif; ?>
            </form>
        ...
        <div class="products-grid">
          <?php if (count($products) > 0): ?>
              ...
              <div class="product-card">
                <div class="product-image">
                  <a href="../product_preview.php?id=<?php echo $product['id'] ?>">
                    <img src="../category/kids/<?php echo $product['image']; ?>" />
                  </a>
                </div>
            ...
            <?php endforeach; ?>
          <?php else: ?>
            <p>No products found in kid's category. Please add products to the database.☹️</p>
          <?php endif; ?>
        </div>
        <!-- close product-list -->
