...
<body>
  <div class="container">
    ...
    <div class="products-main">
      <h2>Men's Apparel <span class="product-count">(<?php echo $product_count; ?>)</span></h2>
      <p>
        Products Elevate your wardrobe with our premium men's collection
        featuring everything from athletic wear to casual essentials. Discover
        performance-driven activewear from top brands like Nike, Adidas, and
        Under Armour, perfect for training or everyday comfort. Our range
        includes moisture-wicking t-shirts, durable training pants, and
        versatile hoodies designed for both style and functionality. Whether
        you're hitting the gym or relaxing on weekends, find the perfect fit
        with sizes ranging from S to XXL and contemporary colors to match any
        preference.
      </p>
      <hr />
      ...
      <div class="products-container">
        ...
        <div class="filter-section">
          ...
          <!-- form -->
          <form method="GET" action="menproduct.php">
            ...
            <?php if (isset($_GET['category']) || isset($_GET['price']) || isset($_GET['size'])): ?>
              <br>
              <a href="menproduct.php" style="text-align: center; display: block; margin-top: 10px; color: #3498db;">
                Clear All Filters
              </a>
            <?php endif; ?>
          </form>
        ...
        <div class="products-grid">
          <?php if (count($products) > 0): ?>
              ...
              <div class="product-card">
                <div class="product-image">
                  <a href="../product_preview.php?id=<?php echo $product['id'] ?>">
                    <img src="../category/men/<?php echo $product['image']; ?>" />
                  </a>
                </div>
            ...
            <?php endforeach; ?>
          <?php else: ?>
            <p>No products found in Men's category. Please add products to the database.☹️</p>
          <?php endif; ?>
        </div>
  ...
  <script>
    document.getElementById('filterToggleBtn')?.addEventListener('click', function() {
      document.querySelector('.filter-mobile-section').classList.add('active');
    });

    document.querySelector('.close-filter-btn')?.addEventListener('click', function() {
      document.querySelector('.filter-mobile-section').classList.remove('active');
    });
  </script>
</body>
