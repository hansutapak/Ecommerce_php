...
<body>
  <div class="container">
    ...
    <div class="products-main">
      <h2>Socks <span class="product-count">(<?php echo $product_count; ?>)</span></h2>
      <p>
      ...
      <div class="products-container">
        ...
        <div class="filter-section">
          ...
          <!-- form -->
          <form method="GET" action="sockproduct.php">
            ...
            <?php if (isset($_GET['category']) || isset($_GET['price']) || isset($_GET['size'])): ?>
              <br>
              <a href="sockproduct.php" style="text-align: center; display: block; margin-top: 10px; color: #3498db;">
                Clear All Filters
              </a>
            <?php endif; ?>
          </form>
        ...
        <div class="products-grid">
          <?php if (count($products) > 0): ?>
              ...
              <div class="product-card">
                <div class="product-image">
                  <a href="../product_preview.php?id=<?php echo $product['id'] ?>">
                    <img src="../category/socks/<?php echo $product['image']; ?>" />
                  </a>
                </div>
            ...
            <?php endforeach; ?>
          <?php else: ?>
            <p>No products found in socks category. Please add products to the database.☹️</p>
          <?php endif; ?>
        </div>
        <!-- close product-list -->
